    ...
    public class TakeCover : BTNode {
        ...
        public override BTTaskStatus Tick(BlackBoard bb) {
            if (!bb.GetValue<bool>("IsTakingCover")) {
                ...
                PathRequestManager.RequestPath(new PathRequest(bb.GetValue<GameObject>("Agent").transform.position, bb.GetValue<Collider>("NearestCoverPoint").transform.position,
