...
public class EnemyFOV : MonoBehaviour {
    ...
    public Enemy[] GetAlliesInCommunicationRadius() {
        ...
        foreach (var o in overlap) allies.Add(o.GetComponent<Enemy>());
        return allies.ToArray();
    }

    public Collider[] GetShrinesInCommunicationRadius() {
        return Physics.OverlapSphere(transform.position, communicationRadius, LayerMask.GetMask("Shrine"));
    }
